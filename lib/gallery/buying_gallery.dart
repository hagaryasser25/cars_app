...
class BuyingGallery extends StatefulWidget {
  String name;
  static const routeName = '/buyingList';
  BuyingGallery({required this.name});

  @override
  State<BuyingGallery> createState() => _BuyingGalleryState();
}

class _BuyingGalleryState extends State<BuyingGallery> {
