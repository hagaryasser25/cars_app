...
class ReplaceCar extends StatefulWidget {
  String galleryName;
  String carName;
  static const routeName = '/replaceCar';
  ReplaceCar({required this.galleryName, required this.carName});

  @override
  State<ReplaceCar> createState() => _ReplaceCarState();
}

class _ReplaceCarState extends State<ReplaceCar> {
                  ...
                  SizedBox(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        border: OutlineInputBorder(),
                        hintText: "نوع السيارة التى تريد استبدالها",
                      ),
                    ),
                  ),
                  SizedBox(
...
void showAlertDialog(BuildContext context) {
  ...
  AlertDialog alert = AlertDialog(
    title: Text("Notice"),
    content: Text("تم ارسال طلب الأستبدال"),
    actions: [
      remindButton,
    ],
  );
